    ...
    if ladrao != []:
        ...
        if ladrao != []:
            ...
            if len(ladrao) == 1:
                ...
                print(
                    f"{mentiraLocal} nem estava aberto nessa hora, esse lugar foi fechado às {fechamento}! {ladrao} roubou os melões!")
            else:
                ladrao = sorted(ladrao)
                mentiraLocal = sorted((mentiraLocal))
                ...
                print(
                    f"{todosLocais} nem estavam abertos nessa hora, esses lugares foram fechados beeem antes! {todosLadroes} se uniram e roubaram os melões!")
            ...
            if len(ladrao) == 1:
                print(
                    f"{todosLadroes} estava a {distancias[0]} metros da plantação! Agora é nosso suspeito número um. Fiquem de olho!")
            else:
                print(
                    f"{todosLadroes} estavam a {distancias[0]} metros da plantação! Eles podiam estar cometendo o roubo juntos... Fiquem de olho!")
